...
# install neovim
exec_step 1 2 "installing neovim & more..." "sudo pacman -S --noconfirm neovim ripgrep nodejs npm;curl -fsSL https://bun.sh/install | bash;bun i -g prettier biome eslint"
