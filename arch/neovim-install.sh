...
# install neovim
exec_step 1 2 "installing neovim & required packages..." "sudo pacman -S neovim ripgrep nodejs npm unzip;curl -fsSL https://bun.sh/install | bash;bun i -g prettier biome eslint"
